...
namespace Dragon.Core
{
    ...
    [TopTitle(
        ...
        BoldName = true,SetTransform = true,HideNameOnMid = true,ShowNameOnPrefix = true,ShowTypeOnSuffix = true)]
    public struct DataKeyField<T>
    {
        ...
        [HorizontalGroup(GroupID = "install",Width = 0.65f)]
        [HideIf("HideIfKey")]
        public DataKey Key;
        ...
        {
            if (Key != null) return Key.ID;
            else return string.Empty;
        }
    
        [Button("Create")][HorizontalGroup(GroupID = "install",Width = 0.3f)][ShowIf("ShowBeginCreate")][PropertyOrder(-1)]
